"""Caso de uso `ListAddresses` (RF-007)."""
...
class ListAddresses:
    """Lista las direcciones activas de un cliente existente (RF-007)."""
    ...
    def execute(self, customer_id: CustomerId) -> OperationResult:
        ...
        return OperationResult.ok(
            ...
            entity=Entity.ADDRESS,
            entity_status=None,
            message="Direcciones listadas exitosamente.",
            data={"items": [address_to_dict(address) for address in addresses]},
        )
